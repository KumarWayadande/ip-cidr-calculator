    ...
    <div className="main-container flex flex-col">
      <div className="main-container-child my-10 w-[100%] sm:w-[95%] md:w-[80%] mx-auto flex flex-col">
        ...
        <div className="footer text-center w-full mx-auto mt-10 pt-10 border-stone-400 border-t-[1px]">
          <span>Create by <a className="text-blue-600 hover:underline" href="https://kumarwayadande.tech">Kumar Wayadande</a>. Source available on <a className="text-blue-600 hover:underline" href="https://github.com/KumarWayadande">Github</a>.</span>
        </div>
      </div>
    </div>
  );
